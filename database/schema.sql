...
----------------------------------------------------
-- BOOTH DESIGNS (guided questionnaire)
----------------------------------------------------
...
CREATE INDEX idx_booth_designs_user ON booth_designs(user_id);
CREATE INDEX idx_booth_designs_created ON booth_designs(created_at DESC);